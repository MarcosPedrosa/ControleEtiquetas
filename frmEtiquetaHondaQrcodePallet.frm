...
Begin VB.Form frmEtiquetaHondaQrcodePallet 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Etiquetas Hoda Qrcode por Pallet"
   ClientHeight    =   6360
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   15375
   ...
   Begin VB.Frame Frame2 
      ...
      Begin MSFlexGridLib.MSFlexGrid Grid1 
         ...
         SelectionMode   =   1
         AllowUserResizing=   1
         FormatString    =   $"frmEtiquetaHondaQrcodePallet.frx":0000
   ...
   Begin VB.CommandButton cmdfechar 
      Height          =   735
      Left            =   6930
      Picture         =   "frmEtiquetaHondaQrcodePallet.frx":0009
      Style           =   1  'Graphical
      TabIndex        =   7
   ...
   Begin VB.CommandButton cmd_Impressao 
      ...
      Height          =   735
      Left            =   5910
      Picture         =   "frmEtiquetaHondaQrcodePallet.frx":044B
      Style           =   1  'Graphical
      TabIndex        =   6
   ...
   Begin VB.Frame frm_filtro 
      ...
      Top             =   90
      Width           =   15195
      Begin VB.TextBox txtSeqPallet 
         BackColor       =   &H00FFFFFF&
         Height          =   315
         Left            =   3960
         MaxLength       =   15
         TabIndex        =   2
         ToolTipText     =   "Digie a sequencial do Pallet"
         Top             =   420
         Width           =   1965
      End
      ...
      Begin VB.CommandButton cmd_limpar 
         Height          =   495
         Left            =   7230
         Picture         =   "frmEtiquetaHondaQrcodePallet.frx":0755
         Style           =   1  'Graphical
         TabIndex        =   4
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton btoConfirma 
         Height          =   495
         Left            =   6660
         Picture         =   "frmEtiquetaHondaQrcodePallet.frx":0B97
         Style           =   1  'Graphical
         TabIndex        =   3
   ...
   End
End
Attribute VB_Name = "frmEtiquetaHondaQrcodePallet"
...
If Len(Trim(Me.txtNotaFiscal.Text)) = 0 Then
   MsgBox "O Sequencial da Nota Fiscal esta em brancos, Preencha!"
   Me.txtNotaFiscal.SetFocus
   Exit Sub
End If

If Len(Trim(Me.txtSeqPallet.Text)) = 0 Then
   MsgBox "O Sequencial do Pallet esta em brancos, Preencha!"
   Me.txtSeqPallet.SetFocus
   Exit Sub
End If
...
Set cRec = CCTempneMov_Etiq.Mov_Etiq_Consultar_Filtro_HONDA_QRCODE_PALLET(sBancoMusashi, _
                                                                          Me.txtNotaFiscal.Text, _
                                                                          Me.txtSeqPallet.Text, _
                                                                          sData)
...
For nx = 1 To cRec.RecordCount
    ...
    Grid1.col = 18: Grid1.Text = IIf(IsNull(cRec.Fields("PALLET")), " ", cRec.Fields("pallet"))
    Grid1.col = 0
...
Grid1.col = 1: Grid1.ColWidth(1) = 1000: Grid1.Text = "PECA"
...
Grid1.col = 8: Grid1.ColWidth(8) = 1000: Grid1.Text = "CLIENTE"
Grid1.col = 9: Grid1.ColWidth(9) = 0: Grid1.Text = "FORNECEDOR"
Grid1.col = 10: Grid1.ColWidth(10) = 1000: Grid1.Text = "CLIENTE"
Grid1.col = 11: Grid1.ColWidth(11) = 1: Grid1.Text = "TIPO EMB."
Grid1.col = 12: Grid1.ColWidth(12) = 1000: Grid1.Text = "DATA"
Grid1.col = 13: Grid1.ColWidth(13) = 1: Grid1.Text = "QT.VOLUME"
Grid1.col = 14: Grid1.ColWidth(14) = 1: Grid1.Text = "COD.EMB"
Grid1.col = 15: Grid1.ColWidth(15) = 1000: Grid1.Text = "QT.VOLUME"
Grid1.col = 16: Grid1.ColWidth(16) = 1: Grid1.Text = "TP.CAIXA"
Grid1.col = 17: Grid1.ColWidth(17) = 1000: Grid1.Text = "DT.FATUR"
Grid1.col = 18: Grid1.ColWidth(18) = 1000: Grid1.Text = "PALLET"
...
If Len(Trim(txtNotaFiscal.Text)) = 11 Then
