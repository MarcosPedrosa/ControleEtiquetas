...
Begin VB.Form frmEtiquetaAjusteEmb 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Re-emissão de etiquetas de Embarque"
   ClientHeight    =   4845
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9465
   ...
   Begin VB.CommandButton cmd_visualizar 
      ...
      Height          =   735
      Left            =   6030
      Picture         =   "frmEtiquetaAjusteEmb.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   21
   ...
   Begin VB.Frame Frame2 
      ...
      Begin MSFlexGridLib.MSFlexGrid Grid1 
         ...
         SelectionMode   =   1
         AllowUserResizing=   1
         FormatString    =   $"frmEtiquetaAjusteEmb.frx":0442
   ...
   Begin VB.CommandButton cmdfechar 
      Height          =   735
      Left            =   8400
      Picture         =   "frmEtiquetaAjusteEmb.frx":044B
      Style           =   1  'Graphical
      TabIndex        =   18
   ...
   Begin VB.CommandButton cmd_Impressao 
      ...
      Height          =   735
      Left            =   4980
      Picture         =   "frmEtiquetaAjusteEmb.frx":088D
      Style           =   1  'Graphical
      TabIndex        =   17
   ...
   Begin VB.Frame frm_filtro 
      ...
      Begin VB.CommandButton cmd_limpar 
         Height          =   495
         Left            =   8610
         Picture         =   "frmEtiquetaAjusteEmb.frx":0B97
         Style           =   1  'Graphical
         TabIndex        =   5
         TabStop         =   0   'False
      ...
      Begin VB.CommandButton btoConfirma 
         Height          =   495
         Left            =   8040
         Picture         =   "frmEtiquetaAjusteEmb.frx":0FD9
         Style           =   1  'Graphical
         TabIndex        =   4
   ...
   Begin VB.CommandButton CMD_IMPRIME_TODAS 
      Height          =   735
      Left            =   7320
      Picture         =   "frmEtiquetaAjusteEmb.frx":12E3
      Style           =   1  'Graphical
      TabIndex        =   2
      ToolTipText     =   "Imprimir"
      Top             =   4050
   ...
   End
End
Attribute VB_Name = "frmEtiquetaAjusteEmb"
...
Set cRec = CCTempneMov_Etiq.Mov_Etiq_Consultar_Ajuste(sBancoMusashi, _
...
If Val(txt_qtde_imprime.Text) > 0 Then
   If Grid1.Rows < Val(txt_qtde_imprime.Text) Then
      nqtde = Grid1.Rows
      MsgBox "sera impreeso apenas o que falta!"
   Else
...
Set cRec = CCTempneMov_Etiq.Mov_Etiq_Consultar_Ajus_Emb(sBancoMusashi, _
                                                        sSequencial)
