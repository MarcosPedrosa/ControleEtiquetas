VERSION 5.00
Begin {C0E45035-5775-11D0-B388-00A0C9055D8E} dteEtiquetas 
   ClientHeight    =   11790
   ClientLeft      =   0
   ClientTop       =   285
   ClientWidth     =   23040
   ...
   _ExtentY        =   20796
   FolderFlags     =   7
   TypeLibGuid     =   "{AB2C87CA-18EC-11D8-8337-00D009FA59EC}"
   TypeInfoGuid    =   "{AB2C87CB-18EC-11D8-8337-00D009FA59EC}"
   TypeInfoCookie  =   0
   Version         =   4
   NumConnections  =   1
   BeginProperty Connection1 
      ConnectionName  =   "ConEtiquetas"
      ConnDispId      =   1012
      SourceOfData    =   3
      ConnectionSource=   "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\Arquivos de programas\Etiquetas\Etiq.mdb;Persist Security Info=False"
      Expanded        =   -1  'True
      QuoteChar       =   96
      SeparatorChar   =   46
   EndProperty
   ...
   BeginProperty Recordset1 
      CommandName     =   "Etiquetas"
      CommDispId      =   1013
      RsDispId        =   1015
      CommandText     =   "etiquetas"
      ActiveConnectionName=   "ConEtiquetas"
      CommandType     =   2
      dbObjectType    =   1
      Prepared        =   -1  'True
      Locktype        =   3
      ...
      BeginProperty Field14 
         ...
         Scale           =   0
         Type            =   202
         Name            =   "Cod_Embalagem_Pw"
         Caption         =   "Cod_Embalagem_Pw"
      EndProperty
      ...
      BeginProperty Field16 
         ...
         Scale           =   0
         Type            =   202
         Name            =   "Classe_Funcional"
         Caption         =   "Classe_Funcional"
      EndProperty
      BeginProperty Field17 
         ...
         Scale           =   0
         Type            =   202
         Name            =   "Embarque_Controlado"
         Caption         =   "Embarque_Controlado"
      EndProperty
      ...
      BeginProperty Field21 
         ...
         Scale           =   0
         Type            =   202
         Name            =   "Ind_Suplementar"
         Caption         =   "Ind_Suplementar"
      EndProperty
      ...
      BeginProperty Field32 
         ...
         Scale           =   0
         Type            =   202
         Name            =   "DESVIO_AVISO_MOD"
         Caption         =   "DESVIO_AVISO_MOD"
      EndProperty
      ...
      BeginProperty Field35 
         ...
         Scale           =   0
         Type            =   202
         Name            =   "MOTIVO_ALTERACAO_OUTROS"
         Caption         =   "MOTIVO_ALTERACAO_OUTROS"
      EndProperty
      ...
      BeginProperty Field41 
         ...
         Scale           =   0
         Type            =   202
         Name            =   "CODIGO_PRODUTO1"
         Caption         =   "CODIGO_PRODUTO1"
      EndProperty
      ...
      BeginProperty Field45 
         ...
         Scale           =   0
         Type            =   202
         Name            =   "CODIGO_PRODUTO2"
         Caption         =   "CODIGO_PRODUTO2"
      EndProperty
      ...
      BeginProperty Field49 
         ...
         Scale           =   0
         Type            =   202
         Name            =   "CODIGO_PRODUTO3"
         Caption         =   "CODIGO_PRODUTO3"
      EndProperty
      ...
      BeginProperty Field53 
         ...
         Scale           =   0
         Type            =   202
         Name            =   "CODIGO_PRODUTO4"
         Caption         =   "CODIGO_PRODUTO4"
      EndProperty
      ...
      BeginProperty Field67 
         ...
         Scale           =   0
         Type            =   2
         Name            =   "sequencia_placa"
         Caption         =   "sequencia_placa"
      EndProperty
   ...
   EndProperty
End
Attribute VB_Name = "dteEtiquetas"
