...
Begin VB.Form frmEtiquetaDesmembra 
   ...
   Begin VB.Label Label4 
      Caption         =   "atenção a tela de login do usuario esta abaixo, aumente o form"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
...
If MsgBox("Você desmembrará esta etiqueta após confirmação, Deseja continuar?", vbQuestion + vbYesNo, "ATENÇÃO !!!") = vbNo Then Exit Sub
...
'''Rem estes campos é para ficar com o mesmo numero de itens para a proxima camada
'''cFields.Add ""
'''cFields.Add ""
...
If KeyCode = 13 Then
   If Me.ActiveControl.TabIndex > 0 Then
      If Me.ActiveControl.TabIndex = 5 Then
         Me.cmd_Visualizar.Enabled = True ' Habilitar o botão de gerar etiqueta
      End If
'      SendKeys "{TAB}"
   End If
...
If MsgBox("Para desmembrar uma etquieta, precisará ser usuário cadastrado, Deseja continuar?", vbQuestion + vbYesNo, "ATENÇÃO !!!") = vbNo Then
   Me.frm_usuario.Top = 4950
   Me.frm_usuario.Left = 900
   Me.MousePointer = vbDefault
...
'---------------------------------------------------------------------------------------------------
'Se tipo 4 opcao padrão etiqueta NOVA MDA 26/04/2019
