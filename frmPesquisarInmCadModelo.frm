...
Begin VB.Form frmPesquisarInmCadModelo 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Pesquisar Modelos da Inmetro"
   ClientHeight    =   4650
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8505
   ...
   End
End
Attribute VB_Name = "frmPesquisarInmCadModelo"
...
Set rs = CCTempneInmetroCadmodelo.INM_CAD_MODELO_Consultar(sBancoMusashi)
...
Grid1.col = 1:  Grid1.ColWidth(1) = 2500: Grid1.Text = "DESCRIÇÃO"
Grid1.col = 2: Grid1.ColWidth(2) = 1500: Grid1.Text = "REGISTRO"
Grid1.col = 3: Grid1.ColWidth(3) = 3000: Grid1.Text = "MODELO 1"
...
Public Function Carregar_Grid()
   ...
   For nx = 1 To rs.RecordCount
       ...
       Grid1.col = 1: Grid1.Text = rs.Fields("DESCRICAO")
       Grid1.col = 2: Grid1.Text = IIf(IsNull(rs.Fields("REGISTRO_INMETRO")), "", rs.Fields("REGISTRO_INMETRO"))
       Grid1.col = 3: Grid1.Text = IIf(IsNull(rs.Fields("DESC_MOD1")), "", rs.Fields("DESC_MOD1"))
       rs.MoveNext
       If Not rs.EOF Then
