...
Begin VB.Form frmEtiquetaAjuste 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "AJuste Etiquetas "
   ClientHeight    =   5010
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9435
   ...
   Begin VB.CommandButton CMD_IMPRIME_TODAS 
      Height          =   735
      Left            =   7320
      Picture         =   "frmEtiquetaAjuste.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   25
   ...
   Begin VB.Frame frm_filtro 
      ...
      Begin VB.CommandButton btoConfirma 
         Height          =   495
         Left            =   8040
         Picture         =   "frmEtiquetaAjuste.frx":030A
         Style           =   1  'Graphical
         TabIndex        =   12
      ...
      Begin VB.CommandButton cmd_limpar 
         Height          =   495
         Left            =   8610
         Picture         =   "frmEtiquetaAjuste.frx":0614
         Style           =   1  'Graphical
         TabIndex        =   11
         TabStop         =   0   'False
   ...
   Begin VB.CommandButton cmd_Impressao 
      ...
      Height          =   735
      Left            =   4980
      Picture         =   "frmEtiquetaAjuste.frx":0A56
      Style           =   1  'Graphical
      TabIndex        =   4
      ToolTipText     =   "Imprimir"
      Top             =   5190
   ...
   Begin VB.CommandButton cmdfechar 
      Height          =   735
      Left            =   8400
      Picture         =   "frmEtiquetaAjuste.frx":0D60
      Style           =   1  'Graphical
      TabIndex        =   3
   ...
   Begin VB.Frame Frame2 
      ...
      Begin MSFlexGridLib.MSFlexGrid Grid1 
         ...
         SelectionMode   =   1
         AllowUserResizing=   1
         FormatString    =   $"frmEtiquetaAjuste.frx":11A2
   ...
   Begin VB.CommandButton cmd_visualizar 
      ...
      Height          =   735
      Left            =   6030
      Picture         =   "frmEtiquetaAjuste.frx":11AB
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "frmEtiquetaAjuste"
...
Set cRec = CCTempneMov_Etiq.Mov_Etiq_Consultar_Ajus(sBancoMusashi, _
                                                   sSequencial)
