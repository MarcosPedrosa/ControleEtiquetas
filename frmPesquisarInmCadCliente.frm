...
Begin VB.Form frmPesquisarInmCadCliente 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Pesquisar Clientes da Inmetro"
   ClientHeight    =   4635
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8520
   ...
   End
End
Attribute VB_Name = "frmPesquisarInmCadCliente"
...
Set rs = CCTempneInmetroCadCliente.INM_CAD_CLIENTE_Consultar(sBancoMusashi)
...
Grid1.col = 2: Grid1.ColWidth(2) = 2: Grid1.Text = ""
...
Public Function Carregar_Grid()
   ...
   For nx = 1 To rs.RecordCount
       ...
       Grid1.col = 2: Grid1.Text = IIf(IsNull(rs.Fields("SAC")), "", rs.Fields("SAC"))
       rs.MoveNext
       If Not rs.EOF Then
